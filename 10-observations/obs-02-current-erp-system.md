...
created: 2026-08-13
updated: 2026-08-13
tags: [observation, erp, current-system, screens]
...
Pyramid operates a desktop ERP system (Windows-based, likely **Udyog ERP** — name unconfirmed, transcribed as "Ugi RP"/"Oogi RP" in site visit audio). Implemented at GST rollout ~2018. Used for indent-through-PO and sales order onward. Described by Rohan as "reactive, not proactive." Tally runs downstream for accounting.
...
| PO-to-Sales Order gap | Every procurement cycle | Manual handling via paper, phone, email, WhatsApp — routed through VP | No visibility on goods in transit, pending LRs (5-8+ days), pending GRNs, missing raw materials, critical spares not received. Cash trapped in inventory |
