...
- [Bill of Materials — IBC, HDPE Drum, MS Drum](obs-06-bom-analysis.md) — 2026-08-21. Pyramid's own BOM workbooks. **4-level IBC BOM** (coil → pipe → cut piece → cage), plastic recipes with **regrind as a planned input** (26–30% of charge), six pallet types, MS routing with **painting as a customer-driven step**. Six data-quality findings incl. 🔴 **the cage is missing from the final IBC BOM**. Unit 9 (EPR plant) documented but **out of demo scope**
