...
| REQ-SO-002 | `[ASSUMPTION]` Order intake channel | proc-03 Q1: "completely unknown" | **Invent a plausible intake flow and label it as assumption.** No evidence of the actual channel |
...
1. **How does a customer order arrive?** Channel, format, who receives it. Still open.
...
5. **Who raises the SO?** Sales team at HO, or at plant?
6. **Pricing model.** Per-SKU fixed price, or group SKU with weight/size surcharge?
