...
4b. ⚠️ **Who decides a cancelled order's stock can be reworked, and for whom?** **Partly answered 2026-08-31: the procurement team finds the replacement buyer** — notably **not sales** (obs-08 §4). The team that buys also places cancelled stock. proc-03 Exception A gives the live example — Grasim cancelling at large quantity, with stock that must leave *"because otherwise everything would come to a standstill."* `[UNKNOWN: how they find the buyer, how fast, and at what price against the original. With finished goods turning in 1–2 days there is no time to work it out slowly.]`
