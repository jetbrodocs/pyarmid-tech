...
updated: 2026-08-27
demo_areas: [8]
tags: [prd, demand, forecast, planning, sales, greenfield]
...
- **Day-one cold start.** No historical demand exists. The dashboard populates as Phlo captures sales orders. Early views will be sparse — do not oversell forecasting capability. Rough shape: the pipeline and demand-vs-stock views (REQ-DP-001, REQ-DP-005) are useful from day one because they read open orders; trend, fulfillment rate, and concentration (REQ-DP-002, 003, 006) need roughly a quarter of captured orders before they say anything. `[TODO: confirm what the demo shows for the trend views given there is no seed data.]`
...
5. **How fresh must these dashboards be?** `[TODO: no requirement in REQ-DP-001..006 states a refresh rate. Live on every event, or a periodic roll-up? Affects the projection design and what the screen shows while rebuilding.]`
