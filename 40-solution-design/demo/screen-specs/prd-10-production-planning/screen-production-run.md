...
| Home                                             | _N runs in progress_ tile         | Same                                 |
...
| **From a released work order** | Target pre-filled, output blank, cursor in _Good_                                                      |
| Partial run saved              | Blue strip: _"Run in progress — 120 of 260 posted −1 d."_ Remaining target shown                       |
...
| Rejects entered                | Regrind panel updates — plastic only. On a steel run it reads _"Steel rejects are waste, not regrind"_ |
...
| Posted                         | Toast — _"258 produced. Serials …-0412 to …-0669. 2,214.9 kg consumed."_ with **View stock**           |
