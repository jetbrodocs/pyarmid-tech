...
2. **Is there a stock-take or physical verification cycle?** No evidence of one exists. Phlo may need to support periodic count adjustments.
3. **What Excel files exist today, held by whom, at which plants?** Scope of the spreadsheet problem.
4. **Does a refurbished unit keep its serial?** Affects serial-level traceability.
